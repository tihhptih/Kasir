<h4 style="padding: 15px">Kategori 
    <ol class="breadcrumb" style="font-size: 20px; margin-top: 10px" >
...
<?php } else { ?>
    <form method="POST" action="fungsi/tambah/tambah.php?kategori=tambah" style="padding: 10px;">
        <table>
            <tr>
                ...
                <td style="padding-left:10px;"><button id="tombol-simpan" class="btn btn-success text-black"><i class="fa fa-plus"></i>
...
<div class="card card-body">
    <div class="table-responsive">
        <table class="table table-bordered table-striped " id="example1">
            <thead>
                <tr class="background-color:#FFFF text-black">
                    <th>No.</th>
                    <th>Kategori</th>
                    <th>Tanggal Input</th>
                    <th>Aksi</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?page=kategori&uid=<?php echo $isi['id_kategori']; ?>"><button class="btn btn btn-warning">Edit</button></a>
