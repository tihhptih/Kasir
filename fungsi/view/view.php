...
class view
{
    ...
    {
        $sql = "select*from login where id_member= ?";
        $row = $this-> db -> prepare($sql);
    ...
    {
        $sql ="SELECT nota.* , barang.id_barang, barang.nama_barang, login.id_member, login.nm_member from nota 
                left join barang on barang.id_barang=nota.id_barang 
                left join login on login.id_member=nota.id_member 
                where nota.periode = ?
    ...
    {
        $sql ="SELECT nota.* , barang.id_barang, barang.nama_barang, login.id_member,
                login.nm_member from nota 
                left join barang on barang.id_barang=nota.id_barang 
                left join login on login.id_member=nota.id_member WHERE nota.periode = ? 
    ...
    public function hari_jual($hari)
    {
        ...
        $sql ="SELECT nota.* , barang.id_barang, barang.nama_barang, login.id_member,
                login.nm_member from nota 
                left join barang on barang.id_barang=nota.id_barang 
                left join login on login.id_member=nota.id_member WHERE nota.tanggal_input LIKE ? 
                ORDER BY id_nota ASC";
        $row = $this-> db -> prepare($sql);
    ...
    {
        $sql ="SELECT penjualan.* , barang.id_barang, barang.nama_barang, login.id_member,
                login.nm_member from penjualan 
                left join barang on barang.id_barang=penjualan.id_barang 
                left join login on login.id_member=penjualan.id_member
